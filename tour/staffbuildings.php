<html>
	<head>
		<title>Staff Buildings | Camp Marcella</title>
	...
	<body>
		...
		<div id="content">
			...
			<div id="entry" style="margin-bottom: 15px">
				<div id="entry_header">
					<span class="entry_header_text">
						Staff Buildings Tour
					</span>
				</div>
				<div id="entry_content">
					About this page:<br/>
					-Staff buildings are buildings that are open only to the staff<br/>
					-List general types of staff buildings (residence, etc.)<br/>
